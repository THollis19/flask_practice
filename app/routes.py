...
from app.tranlate import translate
...
def index():
    ...
    return render_template('index.html', form=form, title='Home Page', posts=posts.items, next_url=next_url, prev_url=prev_url)
...
def follow(username):
    ...
    if form.validate_on_submit():
        ...
        if user == current_user:
            flash('You cannt follow yourself!')
